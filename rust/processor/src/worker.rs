...
use crate::{
    ...
    db::common::models::{events_models::events::Event, ledger_info::LedgerInfo, processor_status::ProcessorStatusQuery},
    gap_detectors::{
...
pub struct Worker {
    ...
    pub notif_sender: UnboundedSender<Event>,
}
...
pub fn build_processor(
    ...
    match config {
        ...
        ProcessorConfig::EventsProcessor(config) => {
            Processor::from(EventsProcessor::new(db_pool, config.clone(), per_table_chunk_sizes, notif_sender))
        },
